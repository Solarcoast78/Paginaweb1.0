        ...
        <div className="mb-16">
          <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-xl p-8 md:p-12 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white">La Evolución de una Disciplina</h3>
            </div>
        ...
        <div className="mb-16">
          <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-xl p-8 md:p-12 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white">El Nacimiento de una Idea Revolucionaria</h3>
            </div>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg mb-6">
        ...
        <div className="mb-16">
          <div className="bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-xl p-8 md:p-12 border border-gray-200 dark:border-gray-700">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white">¿De Qué Trata la Mecatrónica?</h3>
            </div>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg mb-6">
